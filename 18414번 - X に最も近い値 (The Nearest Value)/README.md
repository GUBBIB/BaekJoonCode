<!-- ChatGPT를 사용하여 꾸몄습니다 -->
# <img src="https://github.com/GUBBIB/BaekJoonCode/blob/main/Tier_Img/Bronze-4.svg" alt="티어그림" width="30px" height="35px"> [X に最も近い値 (The Nearest Value)](https://www.acmicpc.net/problem/18414)
